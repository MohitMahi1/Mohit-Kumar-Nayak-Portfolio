...
//   {
//     id: 7,
//     title: "Smart Phone Price Analysis / Prediction",
//     description: "Exploratory data analysis and building ML model for price detection on smartphone market data with statistical insights.",
//     icon: Smartphone,
//     tech: ["Python", "Machine Learning", "Pandas", "Numpy", "Matplotlib", "EDA"],
//     category: "Data Analysis",
...
const projects: Project[] = [
  {
    id: 1,
    title: "Pixel-Lens (Color Picker)",
    description: "An AI-powered web app that detects the exact color of any pixel in a uploaded image in real-time using K-Means clustering.",
    icon: Aperture,
    tech: ["Python", "Machine Learning (Unsupervised Learning)", "FastAPI"],
    category: "Machine Learning",
    githubUrl: "https://github.com/MohitMahi1/Color-Picker",
    liveUrl: "https://pixel-lens.vercel.app",
    gradient: "from-violet-500 to-purple-600",
  },
  {
    id: 2,
...
// , "Full-Stack"
const categories = ["All", "Backend", "Mobile", "Data Analysis", "Machine Learning", "Power BI", "Frontend", "Internship"];
            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                <div className="glass-card p-6 h-full flex flex-col hover:border-primary/50 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-primary/10">
                  ...
                  {/* Action Buttons */}
                  <div className={`flex gap-2 ${project.githubUrl && project.liveUrl ? "flex-row" : "flex-col"}`}>
                    {project.githubUrl && (
                      <a
                        href={project.githubUrl}
                        target="_blank"
